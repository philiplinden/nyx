use crate::physics::{PhysicsSettings, Position, Velocity, sympletic_euler};
use crate::physics::nbody::{Mass, COMPUTE_METHOD};
                ...
                tx.send(
                    mapped_query
                        ...
                        .map(|(acceleration, (entity, velocity, position, ..))| {
                            (*velocity, *position) =
                                sympletic_euler(acceleration, *velocity, *position, dt);
